...
export function AppMockup() {
  return (
    <div className="relative mx-auto w-full max-w-4xl pt-12 sm:pt-16">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-border bg-card shadow-[var(--shadow-lift)]">
        ...
        <div className="flex items-center gap-2 border-b border-border/50 bg-muted/30 px-4 py-3">
          ...
          <div className="mx-auto flex h-6 w-64 items-center justify-center rounded-md bg-background/50 text-[10px] font-medium text-muted-foreground shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center p-8 sm:p-16">
          <div className="relative flex w-full max-w-lg flex-col items-center rounded-xl border border-border/40 bg-card p-8 shadow-soft">
            
            <div className="mb-6 flex items-center justify-center gap-4">
              {/* File 1 */}
              <div className="relative flex h-24 w-20 flex-col items-center justify-center rounded-lg border border-primary/20 bg-primary/5 shadow-sm">
                <FileText className="mb-2 size-6 text-primary" />
                <span className="text-[10px] font-medium text-primary">doc_1.pdf</span>
              ...
              <div className="relative flex h-24 w-20 flex-col items-center justify-center rounded-lg border border-primary/20 bg-primary/5 shadow-sm">
                <FileText className="mb-2 size-6 text-primary" />
                <span className="text-[10px] font-medium text-primary">doc_2.pdf</span>
                <div className="absolute -right-2 -top-2 flex size-5 items-center justify-center rounded-full bg-background border border-border shadow-sm">
